  ...
  return (
    <div className={styles["Landing"]}>
      ...
      <div className={styles["Landing-Nav"]}>
        {/* ทำให้ Logo กับ Fitness Frog เป็น Link */}
          ...
          <div className={styles["Landing-Button"]}>
            <div className={styles["Landing-Button1"]}>
              <Link to={"./login"} style={{ textDecoration: "none" }}> 
                <button className={styles["Landing-Login"]}>Log in</button> {/* ทำให้ Log in เป็น Link */}
              </Link>
              <Link to={"./register"} style={{ textDecoration: "none" }}>
                <button className={styles["Landing-Register"]}>Register</button> {/* ทำให้ Register เป็น Link */}
              </Link>
            </div>
